...
class DesignSidebar(QDockWidget):
    ...
    def update_theme(self, dark_mode):
        ...
        if dark_mode:
            style = button_style % ("#2a2a2a", "white", "#3a3a3a")
        else:
            style = button_style % ("#ffffff", "black", "#f0f0f0")
            
        for btn in self.camera_buttons:
            btn.setStyleSheet(style)
        self.algo_button.setStyleSheet(style)